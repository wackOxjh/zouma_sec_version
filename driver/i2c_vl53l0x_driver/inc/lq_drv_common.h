#ifndef __LQ_VL53L0X_DRV_COMMON_H__
#define __LQ_VL53L0X_DRV_COMMON_H__
...
#define DEVICE_ID_NAME          ( "ls,lq_i2c_vl53l0x" ) /* 设备名称, 请勿修改 */
#define DETECT_INTERVAL_MS      ( 500 )                 /* 定义循环检测设备的时间间隔 (毫秒), 感觉间隔时间不合适, 可适当修改（0.5s） */
#define DEVICE_CNT              ( 1 )                   /* 设备数量, 请勿修改 */
#define VL53L0X_DEV_ADDR        ( 0x29 )                /* VL53L0X设备地址, 请勿修改 */
#define DEVICE_NAME             ( "lq_i2c_vl53l0x" )    /* 设备文件名称, 请勿修改 */
